...
async function seed() {
  ...
  await insertIfMissing(schema.workflowStepDefinitions, [
    ...
    { id: "workflow-step-warehouse-receipt", versionId: "workflow-order-standard-v1", stepOrder: 9, titleUz: "Ombor — qabul qilish", titleRu: "Склад — приёмка", titleTr: "Depo — mal kabul", kind: "task", assigneeType: "warehouse_responsible", skipIfRequesterIsAssignee: false },
  ])
